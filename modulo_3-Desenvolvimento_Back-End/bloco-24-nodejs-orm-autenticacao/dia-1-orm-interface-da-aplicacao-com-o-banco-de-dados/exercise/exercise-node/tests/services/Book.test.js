...
describe('BookService', () => {
  describe('#getAll', () => {
    const findAllStub = stub(Books, 'findAll');
    let books;
    ...
    describe('quando não existe nenhum livro cadastrado', () => {
      ...
      it('called Book.findAll', () => {
        expect(Books.findAll.calledOnce).to.be.equals(true);
      });
  ...
  describe('#getById', () => {
    const findByPkStub = stub(Books, 'findByPk');
    let book;
    ...
    describe('quando existe o livro', () => {
      ...
      it('called Book.findByPk', async () => {
        expect(Books.findByPk.calledOnce).to.be.equals(true);
      });
  ...
  describe('#create', () => {
    describe('retorna o registro do livro criado', () => {
      const createStub = stub(Books, 'create');
      const testBook = {
      ...
      it('called Book.create', async () => {
        expect(Books.create.calledOnce).to.be.equals(true);
      });
  ...
  describe('#update', () => {
    const updateStub = stub(Books, 'update');
    ...
    describe('quando existe o livro', () => {
      ...
      it('called Book.update', async () => {
        expect(Books.update.calledOnce).to.be.equals(true);
      });
  ...
  describe('#remove', () => {
    const removeStub = stub(Books, 'destroy');
    ...
    describe('quando existe o livro', () => {
      ...
      it('called Book.destroy', async () => {
        expect(Books.destroy.calledOnce).to.be.equals(true);
      });
