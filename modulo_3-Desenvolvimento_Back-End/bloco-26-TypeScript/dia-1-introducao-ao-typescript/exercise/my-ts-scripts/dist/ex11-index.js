...
const scripts = [
    { name: "Converter comprimento", script: "./ex5-length" },
    { name: "Converter massa", script: "./ex6-mass" },
    { name: "Converter capacidade", script: "./ex7-capacity" },
    { name: "Converter área", script: "./ex8-area" },
    { name: "Converter volume", script: "./ex9-volume" }
];
