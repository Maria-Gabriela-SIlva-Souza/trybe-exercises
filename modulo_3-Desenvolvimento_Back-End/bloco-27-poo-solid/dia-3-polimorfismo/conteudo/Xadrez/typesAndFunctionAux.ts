// 1. Primeiramente vamos definir alguns tipos e uma função auxiliar que checa se determinada lista contém outra lista:
...
// 1.1 Os tipos relacionados ao tabuleiro, BoardColum (coluna), BoardRow (linha) e BoardHouse (casa) são para auxiliar na representação das casas do tabuleiro de xadrez.