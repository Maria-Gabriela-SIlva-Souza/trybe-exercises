...
print(f'ReportLoader(): {ReportLoader()}')
print(f'G3000LoaderAdapter(g3000_loader): {G3000LoaderAdapter(g3000_loader)}')
print(f'ReportAnalyzer(loader): {ReportAnalyzer(loader)}')
print(f'analyzer.average(): {analyzer.average()}')
# Agora funcionará
